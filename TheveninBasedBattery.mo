...
equation
  ...
  connect(integrator.y, Sum.u[2]) annotation(
    Line(points = {{9.4, -22}, {-1.5, -22}, {-1.5, -36}, {-11, -36}}, color = {0, 0, 127}));
  ...
  connect(signalVoltage.n, GND.p) annotation(
  ...
  connect(U_ocv.v, voltageChange.u[2]) annotation(
    Line(points = {{-66, -9}, {-66, -36}, {-69, -36}}, color = {0, 0, 127}));
  connect(voltageChange.y, signalVoltage.v) annotation(
    Line(points = {{-83, -36}, {-88, -36}}, color = {0, 0, 127}));
  connect(signalVoltage.p, U_ocv.p) annotation(
    Line(points = {{-100, -26}, {-76, -26}, {-76, 2}}, color = {0, 0, 255}));
  connect(U_ocv.n, signalVoltage.n) annotation(
    Line(points = {{-56, 2}, {-56, 2}, {-56, -46}, {-100, -46}, {-100, -46}}, color = {0, 0, 255}));
  connect(R_tl.p, I_bat.p) annotation(
    Line(points = {{40, 40}, {52, 40}, {52, 40}, {52, 40}}, color = {0, 0, 255}));
  connect(I_bat.n, load.n) annotation(
    Line(points = {{72, 40}, {72, 40}, {72, -80}, {52, -80}, {52, -80}}, color = {0, 0, 255}));
  annotation(
