...
// Find voltage difference and modify signalVoltage
    ...
    connect(p, voltageSource.n) annotation(
      Line(points = {{-100, 0}, {-98, 0}, {-98, -52}, {-86, -52}, {-86, -32}}, color = {0, 0, 255}));
...
equation
  ...
  connect(pulseLoad.n, ground.p) annotation(
    Line(points = {{-14, -18}, {-50, -18}, {-50, -16}}, color = {0, 0, 255}));
  connect(pulseLoad.p, theveninBasedBattery.n) annotation(
    Line(points = {{6, -18}, {20, -18}, {20, 20}, {6, 20}}, color = {0, 0, 255}));
